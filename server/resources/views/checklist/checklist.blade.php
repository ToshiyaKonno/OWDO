...
<div><p>
    解説    <a href="/download/" class="list-group-item list-group-item-action active">持ち物チェックリストのダウンロードはこちら</a>
    
        <img src="private/checklist.jpg"
        >
</p></div>

    <p>おすすめの商品を下記で紹介しています</p>
    ...
    {{-- <p><a href="storage/checklist/checklist.pdf" download="checklist.pdf">ここからチェックリストをダウンロード</a></p> --}}
